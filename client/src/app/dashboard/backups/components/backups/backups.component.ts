...
export class BackupsComponent implements OnInit{
  ...
  constructor(backupsService: BackupsService,modalService:ModalService,translate:TranslateService) {
  ...
  refresh(){
    this.backupsService.getBackupConfigs().subscribe((configs: BackupConfig[]) => {
      this.backupConfigs = configs;
    });
  }
  add(){
    this.modalService.open(BackupConfigFormComponent,{
